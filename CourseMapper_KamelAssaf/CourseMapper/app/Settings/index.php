...
<div class="content">
	...
	<div id="pageContent">
	  ...
	  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalNewSchool">Create User</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
		 ...
		 <h4 class="h4">User Name<input type="text" id="school_name" class="form-control"/></h4>
          </div>
